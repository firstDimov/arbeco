				...
				<div id="content-load">
					<div class="main-top-content">
						<div class="left-image-mtc">
							...
							<a href="#" data-hover-link="отправить заявку">отправить заявку</a>
						</div>
						<div class="right-image-mtc">
							<div class="black-wr"></div>
							<img src="/images/mtc-image.jpg" alt="mtc image">
						</div>
					</div>
					<div class="services-mc">
						<p>Услуги</p>
						<div class="carts-smc">
							<div class="cart-ser-wr">
								<div class="cart-service-mc">
									<div class="image-cs-mc">
										<div class="black-wr"></div>
										<img src="/images/image-sc1.jpg" alt="image sc">
									</div>
									<div class="info-cs-mc">
										<p>
											Проектирование
										</p>
